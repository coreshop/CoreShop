                        ...
                        ->arrayNode('cart')
                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('model')->defaultValue('Pimcore\Model\Object\TestCart')->cannotBeEmpty()->end()
                        ...
                        ->arrayNode('cart_item')
                            ...
                            ->children()
                                ...
                                ->arrayNode('classes')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('model')->defaultValue('Pimcore\Model\Object\TestCartItem')->cannotBeEmpty()->end()
