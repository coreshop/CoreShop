...
pimcore.plugin.coreshop.update = Class.create({
    ...
    checkFilePermissions: function () {
        ...
        Ext.Ajax.request({
            url: '/admin/CoreShop/update/check-file-permissions',
    ...
    checkForAvailableUpdates: function () {
        ...
        Ext.Ajax.request({
            url: '/admin/CoreShop/update/get-available-updates',
    ...
    updateStart: function (type) {
        ...
        Ext.Ajax.request({
            url: '/admin/CoreShop/update/get-packages',
    ...
    startParallelDownloadPackages: function () {
        ...
        this.parallelJobsInterval = window.setInterval(function () {
            ...
            if (this.parallelJobsFinished == this.parallelJobsTotal) {
                ...
                Ext.Ajax.request({
                    url: '/admin/CoreShop/update/get-jobs',
            ...
            if (this.parallelJobsRunning < maxConcurrentJobs && this.parallelJobsStarted < this.parallelJobsTotal) {
                ...
                Ext.Ajax.request({
                    url: '/admin/CoreShop/update/job-parallel',
                    success: function (response) {
    ...
    startProceduralJobs: function () {
        ...
        this.proceduralJobsInterval = window.setInterval(function () {
            ...
            if (this.proceduralJobsRunning < 1) {
                ...
                Ext.Ajax.request({
                    url: '/admin/CoreShop/update/job-procedural',
                    success: function (response) {
