...
class CoreShopAdminBundle extends AbstractPimcoreBundle
{
    ...
    public function getJsPaths()
    {
        return [
            ...
            '/bundles/coreshopadmin/js/coreshop/shops/panel.js',
            '/bundles/coreshopadmin/js/coreshop/shops/item.js',
            '/bundles/coreshopadmin/js/coreshop/object/tags/coreShopShop.js',
            '/bundles/coreshopadmin/js/coreshop/object/classes/data/coreShopShop.js',
            '/bundles/coreshopadmin/js/coreshop/object/classes/data/coreShopShopMultiselect.js',
