...
use CoreShop\Bundle\CoreShopLegacyBundle\Composite\Dispatcher;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\AbstractWorker;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Elasticsearch;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Getter\AbstractGetter;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Getter\Brick;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Getter\Classificationstore;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Getter\Fieldcollection;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Getter\Localizedfield;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Interpreter\AbstractInterpreter;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Interpreter\LocalizedInterpreter;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Interpreter\Object;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Interpreter\ObjectId;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Interpreter\ObjectIdSum;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Interpreter\ObjectProperty;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Interpreter\Soundex;
use CoreShop\Bundle\CoreShopLegacyBundle\IndexService\Mysql;
...
class IndexService
{
    ...
    {
        self::getIndexDispatcher()->addType('CoreShop\Bundle\CoreShopLegacyBundle\IndexService\\' . ucfirst($type));
    }
