...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Messaging\Message;
...
class Mail extends PimcoreMail
{
    ...
    public static function sendMail($emailDocument, $model, $recipient, $params = [])
    {
        //init Template
        //TODO: Shop init?
        //\CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->initTemplateForShop($shop);
    ...
    public static function sendOrderMail($emailDocument, Order $order, $sendInvoices = false, $sendShipments = false, $params = [])
    {
        ...
        //init Template
        \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->initTemplateForShop($order->getShop());

        $emailParameters = array_merge($order->getCustomer()->getObjectVars(), $params);
        $emailParameters['orderTotal'] = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->formatPrice($order->getTotal());
