 ...
 * @Route("/tax")
 */
class TaxController extends Admin\DataController
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $model = \CoreShop\Bundle\CoreShopLegacyBundle\Model\Tax::class;
    ...
    protected function setDefaultValues(\CoreShop\Bundle\CoreShopLegacyBundle\Model\AbstractModel $model) {
        if($model instanceof \CoreShop\Bundle\CoreShopLegacyBundle\Model\Tax) {
            $model->setRate(0);
            $model->setActive(1);
        }
    }
