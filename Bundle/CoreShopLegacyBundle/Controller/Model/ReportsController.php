...
use CoreShop\Bundle\CoreShopLegacyBundle\Helper\ReportQuery;
 ...
 * @Route("/reports")
 */
class ReportsController extends Admin\AdminController
{
    /**
     * @Route("/get-products-report")
     */
    public function getProductsReportAction(Request $request)
    {
        $filters = $request->get('filters', ['from' => date('01-m-Y'), 'to' => date('m-t-Y')]);
        ...
        return $this->json(['data' => array_values($productSales)]);
    }

    /**
     * @Route("/get-categories-report")
     */
    public function getCategoriesReportAction(Request $request)
    {
        $filters = $request->get('filters', ['from' => date('01-m-Y'), 'to' => date('m-t-Y')]);
        $from = new \Pimcore\Date($filters['from']);
        $to = new \Pimcore\Date($filters['to']);
        ...
        return $this->json(['data' => array_values($catSales)]);
    }

    /**
     * @Route("/get-customers-report")
     */
    public function getCustomersReportAction(Request $request)
    {
        $filters = $request->get('filters', ['from' => date('01-m-Y'), 'to' => date('m-t-Y')]);
        $from = new \Pimcore\Date($filters['from']);
        $to = new \Pimcore\Date($filters['to']);
        ...
        return $this->json(['data' => array_values($custSales)]);
    }

    /**
     * @Route("/get-quantities-report")
     */
    public function getQuantitiesReportAction(Request $request)
    {
        ...
        $sqlOrderBy = ReportQuery::getSqlSort($request->request->all());
        ...
        return $this->json(['data' => $products, "total" => $total]);
    }

    /**
     * @Route("/get-orders-carts-report")
     */
    public function getOrdersCartsReportAction(Request $request)
    {
        $filters = $request->get('filters', ['from' => date('01-m-Y'), 'to' => date('m-t-Y')]);
        $from = new \Pimcore\Date($filters['from']);
        $to = new \Pimcore\Date($filters['to']);
    ...
    /**
     * @Route("/get-orders-carts-abandoned-report")
     */
    public function getOrdersCartsAbandonedReportAction(Request $request)
    {
        ...
        $filters = $request->get('filters', ['from' => $minFrom->get('d.M.y'), 'to' => $maxTo->get('d.M.y')]);

        $page = $request->get('page', 1);
        $limit = $request->get('limit', 25);
        $offset = $request->get('offset', $page === 1 ? 0 : ($page-1)*$limit);
        ...
        return $this->json(['data' => $data, 'count' => count($data), 'total' => $total]);
    }

    /**
     * @Route("/get-sales-report")
     */
    public function getSalesReportAction(Request $request)
    {
        $filters = $request->get('filters', ['from' => date('01-m-Y'), 'to' => date('m-t-Y')]);
        $from = new \Pimcore\Date($filters['from']);
        $to = new \Pimcore\Date($filters['to']);
        ...
        foreach ($results as $result) {
            ...
            $data[] = [
                ...
                'sales' => $result['total'],
                'salesFormatted' => \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->formatPrice($result['total'])
            ];
        }
    ...
    /**
     * @Route("/get-carrier-report")
     */
    public function getCarrierReportAction(Request $request)
    {
        $filter = ReportQuery::extractFilterDefinition($request->get('filters'));
    ...
    /**
     * @Route("/get-payment-report")
     */
    public function getPaymentReportAction(Request $request)
    {
        $filter = ReportQuery::extractFilterDefinition($request->get('filters'));
    ...
    /**
     * @Route("/get-empty-categories-monitoring")
     */
    public function getEmptyCategoriesMonitoringAction(Request $request)
    {
        ...
        return $this->json(['data' => $emptyCategories]);
    }

    /**
     * @Route("/get-disabled-products-monitoring")
     */
    public function getDisabledProductsMonitoringAction(Request $request)
    {
    ...
    /**
     * @Route("/get-out-of-stock-products-monitoring")
     */
    public function getOutOfStockProductsMonitoringAction(Request $request)
    {
