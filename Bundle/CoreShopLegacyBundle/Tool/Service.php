...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\BrickVariant;
...
/**
 * Class Service
 * @package CoreShop\Bundle\CoreShopLegacyBundle\Tool
 */
class Service
{
    /**
                ...
                if (!empty($dimensionInfo)) {
                    foreach ($dimensionInfo as $dimensionGetter => $dimensionMethodData) {
                        ...
                        if (!$getter instanceof BrickVariant) {
                            throw new Exception('Objectbrick "'.$dimensionGetter.'" needs to be a instance of \CoreShop\Bundle\CoreShopLegacyBundle\Model\BrickVariant"');
