...
class Tools
{
    ...
    {
        $results = \Pimcore::getEventDispatcher()->dispatch("coreshop.url", $this, [
            "name" => $name,
            "params" => $userParams,
            "reset" => $reset,
            "encode" => $encode
    ...
    {
        $session = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getSession();
    ...
    public function getCountry()
    {
        ...
        if (!$country instanceof Country) {
            $country = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::actionHook('country');
