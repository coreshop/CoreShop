...
pimcore.plugin.coreshop.taxrulegroups.panel = Class.create(pimcore.plugin.coreshop.abstract.panel, {
    ...
    url : {
        add : '/admin/CoreShop/tax-rule-group/add',
        delete : '/admin/CoreShop/tax-rule-group/delete',
        get : '/admin/CoreShop/tax-rule-group/get',
        list : '/admin/CoreShop/tax-rule-group/list'
    }
});
