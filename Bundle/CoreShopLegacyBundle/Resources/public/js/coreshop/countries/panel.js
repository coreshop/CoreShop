...
pimcore.plugin.coreshop.countries.panel = Class.create(pimcore.plugin.coreshop.abstract.panel, {
    ...
    url : {
        add : '/admin/CoreShop/country/add',
        delete : '/admin/CoreShop/country/delete',
        get : '/admin/CoreShop/country/get',
        list : '/admin/CoreShop/country/list'
    },
        ...
        if (!this.grid) {
            this.store = new Ext.data.Store({
                ...
                proxy:      new Ext.data.HttpProxy({
                    url : '/admin/CoreShop/country/list'
                }),
