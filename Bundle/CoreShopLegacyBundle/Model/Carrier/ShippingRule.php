...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Carrier\ShippingRule\Action;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Carrier\ShippingRule\Condition;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Carrier\ShippingRule\Action\AbstractAction;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Carrier\ShippingRule\Condition\AbstractCondition;
...
class ShippingRule extends AbstractRule
{
    ...
    {
        $class = '\\CoreShop\Bundle\CoreShopLegacyBundle\\Model\\Carrier\\ShippingRule\\Condition\\' . ucfirst($condition);
    ...
    {
        $class = '\\CoreShop\Bundle\CoreShopLegacyBundle\\Model\\Carrier\\ShippingRule\\Action\\' . ucfirst($action);
    ...
    {
        $cacheKey = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getFingerprint() . $carrier->getId() . $address->getCacheKey() . $cart->getCacheKey() . $this->getId();
