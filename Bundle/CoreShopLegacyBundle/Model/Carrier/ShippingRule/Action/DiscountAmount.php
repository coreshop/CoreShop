...
class DiscountAmount extends AbstractAction
{
    ...
    {
        return \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->convertToCurrency(-1 * $this->getAmount(), \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getCurrency(), Model\Currency::getById($this->getCurrency()));
    }
