    ...
    public static function getWorkflowObject() {
        ...
        $workflowObject->setActions([
            [
                ...
                "events" => [
                    "before" => ["\\CoreShop\Bundle\CoreShopLegacyBundle\\Model\\Order\\Workflow", "beforeDispatchOrderChange"],
                    "success" => ["\\CoreShop\Bundle\CoreShopLegacyBundle\\Model\\Order\\Workflow", "dispatchOrderChange"],
                    "failure" => ["\\CoreShop\Bundle\CoreShopLegacyBundle\\Model\\Order\\Workflow", "dispatchOrderChangeFailed"]
                ],
                "notes" => [
