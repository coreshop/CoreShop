...
class Service
{
    ...
    public static function handleRequestAndCreateThread($params, $language, $sendContact = true, $sendCustomer = true)
    {
        ...
        if (!$thread instanceof Thread) {
            ...
            if (\CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getUser() instanceof User) {
                $thread->setUser(\CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getUser());
            }
