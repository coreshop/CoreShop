...
class Base extends Concrete
{
    ...
    {
        return \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->objectToArray($this);
    }
    ...
    public function getUrl($language, $params = [], $route, $reset = false, Shop $shop = null)
    {
        ...
        $url = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->url($params, $route, $reset);
