...
class Manager
{
    ...
    {
        $cartSession = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getSession();
    ...
    public function createCart($name = "default", User $user = null, Shop $shop = null, Currency $currency = null, $persist = false)
    {
        ...
        $cart->setName($name);
        $cart->setCurrency(is_null($currency) ? \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getCurrency() : $currency);
