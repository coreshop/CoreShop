...
namespace CoreShop\Bundle\CoreShopLegacyBundle\Model\Dao;
...
/**
 * Class AbstractDao
 * @package CoreShop\Bundle\CoreShopLegacyBundle\Model\Dao
 */
abstract class AbstractDao extends Dao\AbstractDao
{
    ...
    {
        if ($this->model->isMultiShop()) {
            $this->db->delete($this->getShopTableName(), ["oId" => $this->model->getId()]);
