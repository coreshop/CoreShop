...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Carrier\ShippingRule;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Carrier\ShippingRuleGroup;
...
class Carrier extends AbstractModel
{
    ...
    public static function getCarriersForCart(Cart $cart = null, Address $address = null)
    {
        ...
        if (is_null($address)) {
            $address = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getDeliveryAddress();
        }
