...
namespace CoreShop\Bundle\CoreShopLegacyBundle\Model\Mail;

use CoreShop\Bundle\CoreShopLegacyBundle\Exception;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Mail\Rule\Action\AbstractAction;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Mail\Rule\Condition\AbstractCondition;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Mail\Rule\Action;
use CoreShop\Bundle\CoreShopLegacyBundle\Composite\Dispatcher;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Mail\Rule\Condition;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Rules\AbstractRule;
use Pimcore\Cache;
use Pimcore\Logger;
...
/**
 * Class Rule
 * @package CoreShop\Bundle\CoreShopLegacyBundle\Model\Rule
 */
class Rule extends AbstractRule
{
    ...
    {
        $class = '\\CoreShop\Bundle\CoreShopLegacyBundle\\Model\\PriceRule\\Condition\\' . ucfirst($condition);
    ...
    {
        $class = '\\CoreShop\Bundle\CoreShopLegacyBundle\\Model\\PriceRule\\Action\\' . ucfirst($action);
    ...
    public static function getTypes() {
        $results = \Pimcore::getEventDispatcher()->dispatch('coreshop.rules.mailRules.types.init', static::$types);
    ...
    public function getValidationCacheKey(AbstractModel $object, $params = [])
    {
        ...
        $cacheKey = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getFingerprint() . $paramsKey . $objectKey . $this->getId();
