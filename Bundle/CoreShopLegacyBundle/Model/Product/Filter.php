...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Product\Filter\Condition\Boolean;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Product\Filter\Condition\Combined;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Product\Filter\Condition\Multiselect;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Product\Filter\Condition\Range;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Product\Filter\Condition\Select;
...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Product\Filter\Similarity\Field;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Rules\SerializeTrait;
use Pimcore\Tool;
...
class Filter extends AbstractModel
{
    ...
    {
        self::getConditionDispatcher()->addType('CoreShop\Bundle\CoreShopLegacyBundle\Model\Product\Filter\Condition\\' . ucfirst($condition));
    }
    ...
    {
        self::getSimilaritiesDispatcher()->addType('CoreShop\Bundle\CoreShopLegacyBundle\Model\Product\Filter\Similarity\\' . ucfirst($similarity));
    }
    ...
    public function prepareConditions($conditions)
    {
        ...
        foreach ($conditions as $condition) {
            ...
            if ($className && Tool::classExists($className)) {
                ...
                throw new \CoreShop\Bundle\CoreShopLegacyBundle\Exception(sprintf('Condition with type %s and class %s not found', $condition['type'], $className));
            }
        }
    ...
    public function prepareSimilarities($similarities)
    {
        ...
        foreach ($similarities as $sim) {
            ...
            if ($className && Tool::classExists($className)) {
                ...
                throw new \CoreShop\Bundle\CoreShopLegacyBundle\Exception(sprintf('Similarity with type %s and class %s not found', $sim['type'], $className));
            }
        }
