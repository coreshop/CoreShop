...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Rules\Action\AbstractAction;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Rules\Condition\AbstractCondition;
use Pimcore\Tool;
...
abstract class AbstractRule extends AbstractModel
{
    ...
    public static function getConditionDispatcher()
    {
        ...
        if (!array_key_exists($calledClass, self::$conditionDispatcher) || is_null(self::$conditionDispatcher[$calledClass])) {
    ...
    public static function getActionDispatcher()
    {
        ...
        if (!array_key_exists($calledClass, self::$actionDispatcher) || is_null(self::$actionDispatcher[$calledClass])) {
