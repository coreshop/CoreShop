...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Currency;
...
class DiscountAmount extends AbstractAction
{
    ...
    {
        $amount = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->convertToCurrency($this->getAmount(), $cart->getCurrency(), Currency::getById($this->getCurrency()));
    ...
    {
        return \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->convertToCurrency($this->getAmount(), \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getCurrency(), Currency::getById($this->getCurrency()));
    }
}
