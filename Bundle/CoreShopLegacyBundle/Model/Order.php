...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Messaging\Thread;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Order\Document;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Order\Invoice;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Order\Item;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Order\Payment;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Order\Shipment;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Plugin\Payment as CorePayment;
...
class Order extends Base
{
    ...
    public function importCart(Cart $cart)
    {
        ...
        foreach ($cart->getTaxes() as $tax) {
            ...
            $tax->setAmount(\CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->roundPrice($taxAmount));
    ...
    protected function importCartItem(Cart\Item $cartItem) {
        ...
        \CoreShop\Bundle\CoreShopLegacyBundle\Tool\Service::copyObject($cartItem, $item);
        ...
        $item->setTotal(\CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->roundPrice($cartItem->getTotal()));
        $item->setTotalTax(\CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->roundPrice($cartItem->getTotalProductTax()));
    ...
    public function updateOrderItem(Item $item, $amount, $priceWithoutTax)
    {
        ...
        $translate = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getTranslate();
     ...
     *
     * @return null|\CoreShop\Bundle\CoreShopLegacyBundle\Model\Plugin\Payment
     *
     * @throws ObjectUnsupportedException
     */
    public function getPaymentProviderObject()
    {
        ...
        return \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getPaymentProvider($paymentProvider);
    }
    ...
    public function getOrderPaymentByIdentifier($identifier)
    {
        ...
        /** @var \CoreShop\Bundle\CoreShopLegacyBundle\Model\Order\Payment $payment */
