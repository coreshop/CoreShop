...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Plugin\TaxManager as PluginTaxManager;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\TaxRule\Manager;
...
class TaxManagerFactory
{
    ...
    {
        $results = \Pimcore::getEventDispatcher()->dispatch('coreshop.tax.getTaxManager', null, ['address' => $address, 'type' => $type]);
