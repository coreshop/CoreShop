...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Cart\Item;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Plugin\Payment as PaymentPlugin;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Plugin\Payment;
use CoreShop\Bundle\CoreShopLegacyBundle\Model\PriceRule\Action\FreeShipping;
...
class Cart extends Base
{
    ...
    {
        $cart = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getCartManager()->getSessionCart();

        if (!$cart instanceof Cart) {
            $cart = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getCartManager()->createCart($name, \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getUser(), Shop::getShop());
        }

        if ($persist) {
            \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getCartManager()->persistCart($cart);
        }
    ...
    {
        $paymentProvider = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getPaymentProvider($this->getPaymentModule());
     ...
     *
     * @param \CoreShop\Bundle\CoreShopLegacyBundle\Model\Cart\PriceRule $priceRule
    ...
    public function addPriceRule(PriceRule $priceRule, $voucherCode)
    {
        ...
        if (!$exists) {
            $priceRuleData = \CoreShop\Bundle\CoreShopLegacyBundle\Model\PriceRule\Item::create();
    ...
    /**
     * @return \CoreShop\Bundle\CoreShopLegacyBundle\Model\PriceRule\Item[]
     */
    public function getPriceRules()
    {
        ...
        if ($collection instanceof Fieldcollection) {
            ...
            foreach ($collection->getItems() as $priceRule) {
                if ($priceRule instanceof \CoreShop\Bundle\CoreShopLegacyBundle\Model\PriceRule\Item) {
    ...
    /**
     * @param \CoreShop\Bundle\CoreShopLegacyBundle\Model\PriceRule\Item[] $priceRules
     */
    ...
    public function createOrder(Payment $paymentModule = null, $language = null)
    {
        ...
        if (\CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getVisitor() instanceof Visitor) {
            $order->setVisitorId(\CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getVisitor()->getId());
        }

        \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::actionHook('order.preSave', ['order' => $order, 'cart' => $this]);
        ...
        \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::actionHook('order.created', ['order' => $order]);
    ...
    {
        return \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->formatPrice($price, $this->getBillingAddress() instanceof Address ? $this->getBillingAddress()->getCountry() : null, $this->getCurrency());
    }
    ...
    {
        $sessionCart = \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->getCartManager()->getSessionCart();
    ...
    {
        return \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::getTools()->convertToCurrency($price, $this->getCurrency());
    }
