...
use CoreShop\Bundle\CoreShopLegacyBundle\Model\Plugin\InstallPlugin;
use CoreShop\Bundle\CoreShopLegacyBundle\Plugin\Install;
use Pimcore\Logger;
...
class Plugin extends AbstractPlugin implements PluginInterface
{
    ...
    public function init()
    {
        ...
        \CoreShop\Bundle\CoreShopLegacyBundle\CoreShop::bootstrap($this);
    }
    ...
    public static function install()
    {
        try {
            ...
            \Pimcore::getEventDispatcher()->dispatch('coreshop.install.post', null, ['installer' => $install]);
        } catch (Exception $e) {
            Logger::crit($e);
    ...
    public static function uninstall()
    {
        try {
            ...
            \Pimcore::getEventDispatcher()->dispatch('coreshop.uninstall.pre', null, ['installer' => $install]);
            ...
            \Pimcore::getEventDispatcher()->dispatch('coreshop.uninstall.post', null, ['installer' => $install]);
