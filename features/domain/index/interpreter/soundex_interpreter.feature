...
Feature: Adding a object index
  ...
  Background:
    ...
    And the definition has a relation field "objectHref"
    ...
    And  the index has following fields:
      ...
      | objectHref | soundex    | relation |        | soundex     | STRING     |
  ...
  Scenario: Adding a simple object to the index
    ...
    Then the index column "soundex" for object-instance should have value "48000"
