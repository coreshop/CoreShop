...
Feature: Adding a new Product
  ...
  The product has a price-rule for a store
  ...
  Scenario: Add a new store product price rule which is valid
    Given adding a product price rule to product "Shoe" named "store-discount"
  ...
  Scenario: Add a new store product price rule which is invalid
    Given adding a product price rule to product "Shoe" named "store-discount"
    And the price rule is active
