...
Feature: Adding a new Product
  ...
  The product has a price-rule for a zone
  ...
  Scenario: Add a new zone product price rule which is valid
    Given adding a product price rule to product "Shoe" named "zone-discount"
  ...
  Scenario: Add a new zone product price rule which is invalid
