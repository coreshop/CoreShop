...
Feature: Adding a new Product
  ...
  the product has a price-rule for a time-span
  ...
  Scenario: Add a new timespan product price rule which is valid
    Given adding a product price rule to product "Shoe" named "timespan-discount"
  ...
  Scenario: Add a new timespan product price rule which is invalid
    Given adding a product price rule to product "Shoe" named "timespan-discount"
    And the price rule is active
