...
APP_ENV=test PIMCORE_TEST_DB_DSN=mysql://root:ROOT@coreshop50-db:3306/coreshop5_0___behat DATABASE_URL=mysql://root:ROOT@coreshop50-db:3306/coreshop5_0___behat PIMCORE_ADMIN_USER=admin PIMCORE_ADMIN_PASSWORD=admin PIMCORE_KERNEL_CLASS=Kernel vendor/bin/pimcore-install --install-profile 'CoreShop\Bundle\CoreBundle\InstallProfile\CoreShopInstallProfile' --skip-validation --no-interaction
