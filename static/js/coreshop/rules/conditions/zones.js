...
pimcore.registerNS('pimcore.plugin.coreshop.rules.conditions.zones');

pimcore.plugin.coreshop.rules.conditions.zones = Class.create(pimcore.plugin.coreshop.rules.conditions.abstract, {
