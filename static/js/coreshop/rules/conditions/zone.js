...
pimcore.registerNS('pimcore.plugin.coreshop.rules.conditions.zone');

pimcore.plugin.coreshop.rules.conditions.zone = Class.create(pimcore.plugin.coreshop.rules.conditions.abstract, {
