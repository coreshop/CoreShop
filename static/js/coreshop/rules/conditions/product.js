...
pimcore.registerNS('pimcore.plugin.coreshop.rules.conditions.product');

pimcore.plugin.coreshop.rules.conditions.product = Class.create(pimcore.plugin.coreshop.rules.conditions.abstract, {
