...
pimcore.registerNS('pimcore.plugin.coreshop.rules.conditions.persona');

pimcore.plugin.coreshop.rules.conditions.persona = Class.create(pimcore.plugin.coreshop.rules.conditions.abstract, {
