...
pimcore.plugin.coreshop.rules.abstract = Class.create({

    /**
     * pimcore.plugin.coreshop.rules.item
     */
    parent: {},
    ...
    getTopBar: function (name, index, parent, data, iconCls) {
        ...
        return [{
            ...
            handler: function (blockId, parent, container, namespace) {
                ...
                var index = pimcore.plugin.coreshop.rules[namespace].abstract.prototype.getIndex(blockElement, container);
