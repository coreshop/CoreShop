...
pimcore.plugin.coreshop.messaging.thread.item = Class.create(pimcore.plugin.coreshop.abstract.item, {
    ...
    url : {
        save : '/plugin/CoreShop/admin_MessagingThread/save'
    },
    ...
    changeStatus : function(newStatus) {
        ...
        Ext.Ajax.request({
            url: '/plugin/CoreShop/admin_MessagingThread/change-status',
            params: {
    ...
    sendNewMessage : function(content) {
        ...
        Ext.Ajax.request({
            url: '/plugin/CoreShop/admin_MessagingThread/send-message',
            params: {
                thread: this.data.thread.id,
                message : content
            },
