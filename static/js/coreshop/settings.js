    ...
    getData: function () {
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                this.data = Ext.decode(response.responseText).values;
    ...
    getTabPanel: function () {
        if (!this.panel) {
            ...
            for (var shopId in this.data) {
                            ...
                            items: [
                                {
                                    ...
                                    checked: this.getValue(shopId, 'SYSTEM.MULTISHOP.ENABLED')
                                }
                            ]
                        },
                        {
                ...
                this.shopPanels[shopId] = shopPanel;
