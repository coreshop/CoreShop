...
pimcore.plugin.coreshop.product.pricerule.panel = Class.create(pimcore.plugin.coreshop.pricerules.panel, {
    ...
    initialize: function () {
        ...
        Ext.Ajax.request({
            url: '/plugin/CoreShop/admin_product-price-rule/get-config',
            method: 'GET',
        ...
        this.url = {
            add : '/plugin/CoreShop/admin_product-price-rule/add',
            delete : '/plugin/CoreShop/admin_product-price-rule/delete',
            get : '/plugin/CoreShop/admin_product-price-rule/get',
            list : '/plugin/CoreShop/admin_product-price-rule/list'
        };
    ...
    getNavigation: function () {
        if (!this.grid) {
            ...
            this.store = new Ext.data.Store({
                ...
                proxy: {
                    type: 'ajax',
                    url: '/plugin/CoreShop/admin_product-price-rule/list',
                    reader: {
                        type: 'json',
                        rootProperty : 'data'
                    }
