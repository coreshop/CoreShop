...
{
    public function __construct(private SharedStorageInterface $sharedStorage, private ProductQuantityPriceRuleRepositoryInterface $productQuantityPriceRuleRepository)
    {
    }
