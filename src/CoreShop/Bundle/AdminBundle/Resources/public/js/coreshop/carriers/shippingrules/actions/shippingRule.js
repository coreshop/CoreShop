...
pimcore.registerNS('pimcore.plugin.coreshop.carrier.shippingrules.actions.shippingRule');

pimcore.plugin.coreshop.carrier.shippingrules.actions.shippingRule = Class.create(pimcore.plugin.coreshop.rules.conditions.abstract, {
    type: 'shippingRule',
