...
pimcore.registerNS('pimcore.plugin.coreshop.notification.rules.conditions.payment');

pimcore.plugin.coreshop.notification.rules.conditions.payment = Class.create(pimcore.plugin.coreshop.rules.conditions.abstract, {
    type : 'payment',
