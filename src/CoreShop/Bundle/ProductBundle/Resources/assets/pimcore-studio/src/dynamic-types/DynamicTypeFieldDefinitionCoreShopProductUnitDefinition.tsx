...
export class DynamicTypeFieldDefinitionCoreShopProductUnitDefinition extends DynamicTypeFieldDefinitionCoreShopSelect {
  id: string = 'coreShopProductUnitDefinition'
