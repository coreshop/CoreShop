...
use CoreShop\Bundle\OrderBundle\Form\Type\Studio\OrderPaymentCreationType;
...
final class OrderPaymentCreationSchemaEnricher implements FormSchemaEnricherInterface
{
    public function supports(string $formTypeClass): bool
    {
        return $formTypeClass === OrderPaymentCreationType::class;
    }
