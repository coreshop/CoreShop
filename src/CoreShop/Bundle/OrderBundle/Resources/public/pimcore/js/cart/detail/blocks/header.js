...
pimcore.registerNS('coreshop.order.cart.detail.blocks.header');
coreshop.order.cart.detail.blocks.header = Class.create(coreshop.order.order.detail.abstractBlock, {
    datePanel: null,
    totalPanel: null,
    productPanel: null,
    storePanel: null,
