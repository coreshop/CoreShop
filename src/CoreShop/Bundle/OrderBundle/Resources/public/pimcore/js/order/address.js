...
pimcore.registerNS('coreshop.order.order.address');
coreshop.order.order.address = Class.create({
...
coreshop.order.order.address.addMethods(pimcore.object.helpers.edit);
