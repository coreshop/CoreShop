    ...
    updatePaymentInfoAlert: function () {
        ...
        if (me.paymentInfoAlert) {
            if (me.sale.totalPayed < me.sale.total || me.sale.totalPayed > me.sale.total) {
                me.paymentInfoAlert.update(t('coreshop_order_payment_paid_warning').format(coreshop.util.format.currency(me.sale.currency.iso, me.sale.totalPayed), coreshop.util.format.currency(me.sale.currency.iso, me.sale.totalGross)));
