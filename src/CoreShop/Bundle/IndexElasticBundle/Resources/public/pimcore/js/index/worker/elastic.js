...
pimcore.registerNS('coreshop.worker.type.elastic');
coreshop.index.worker.elastic = Class.create(coreshop.index.worker.abstract, {
    ...
    getIndexGrid: function (localized, config) {
        var me = this;
        var modelName = 'coreshop.model.index.elasticsearch';
        ...
        var grid = Ext.create({
            ...
            store: store,
            minHeight: 200,
            title: t(('coreshop_index_elasticsearch_index' + (localized ? '_localized' : ''))),
            columns: [{
                header: t('type'),
                dataIndex: 'type',
                width: 100,
