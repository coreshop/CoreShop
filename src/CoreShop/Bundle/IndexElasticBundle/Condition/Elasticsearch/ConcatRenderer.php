...
namespace CoreShop\Bundle\IndexElasticBundle\Condition\Elasticsearch;
...
class ConcatRenderer extends AbstractElasticsearchDynamicRenderer
{
    ...
    {
        return $worker instanceof ElasticsearchWorker && $condition instanceof ConcatCondition;
    }
}
