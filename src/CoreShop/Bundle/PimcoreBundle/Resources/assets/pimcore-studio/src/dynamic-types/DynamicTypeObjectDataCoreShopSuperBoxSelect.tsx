...
const SuperBoxSelectComponent: React.FC<{
  value?: number[]
...
export class DynamicTypeObjectDataCoreShopSuperBoxSelect extends DynamicTypeObjectDataAbstractMultiSelect {
  readonly id = 'coreShopSuperBoxSelect'
