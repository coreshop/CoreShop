/*! For license information please see __federation_expose_default_export.8e95337d.js.LICENSE.txt */
"use strict";(self["chunk_coreshopmessenger "]=self["chunk_coreshopmessenger "]||[]).push([["525"],{3676:function(e,r,s){s.r(r),s.d(r,{default:()=>G});var a=s(2977),t=s(4781),l=s(2855),o=s(5168);let n=e=>(0,l.jsxs)("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 48 48",width:"1em",height:"1em",...e,children:[(0,l.jsx)("path",{fill:"#2196F3",d:"M40 10H8a4 4 0 0 0-4 4v20a4 4 0 0 0 4 4h32a4 4 0 0 0 4-4V14a4 4 0 0 0-4-4"}),(0,l.jsx)("path",{fill:"#0D47A1",d:"M44 14.025a4 4 0 0 0-.24-1.32L24 27.025 4.241 12.705A4 4 0 0 0 4 14.025V15l20 14.495L44 15z"})]}),i={onInit(){let e=a.container.get(t.serviceIds.iconLibrary);e.register({name:"coreshop_messenger",component:n}),e.register({name:"coreshop_nav_icon_messenger",component:n})}};var c=s(1605),d=s(6284),u=s(6096),h=s(4958),m=s(8949),g=s(1925),p=s(323),f=s(5210),x=s(9911),y=s(719),b=s(9700),_=s(2580);let{Text:w}=x.A,v=(0,p.rU)(e=>{let{css:r,token:s}=e;return{container:r`
  ...
  `,tabContent:r`
    ...
    overflow: hidden;
    padding: 16px;
  `}}),Q={onInit(){a.container.get(t.serviceIds.widgetManager).registerWidget({name:"coreshop-messenger-widget",component:Z})}};class X{getId(){return this.handlerId}shouldHandle(e){return"update"===e.type&&!!e.payload&&"coreshop.messenger.update"===e.payload.eventType}async handleMessage(e){if(!e.payload)return;let r=e.payload;z.emit(r)}onRegister(){}onUnregister(){}constructor(){this.handlerId="coreshop-messenger-handler"}}let G={name:"coreshop-messenger",onInit(){try{let e=a.container.get(t.serviceIds.globalMessageBus),r=new X;e.registerHandler(r)}catch(e){console.warn("CoreShop MessengerBundle: Failed to register Mercure message handler",e)}},onStartup(e){let{moduleSystem:r}=e;r.registerModule(i),r.registerModule(Q)}}},2989:function(e,r,s){s.d(r,{ZF:()=>l});var a=s(5168),t=s.n(a);s(2703);let l=e=>"string"==typeof e&&e.includes("\n")?t().createElement("div",null,...e.split("\n").map((e,r)=>t().createElement("div",{key:r},e))):e}}]);