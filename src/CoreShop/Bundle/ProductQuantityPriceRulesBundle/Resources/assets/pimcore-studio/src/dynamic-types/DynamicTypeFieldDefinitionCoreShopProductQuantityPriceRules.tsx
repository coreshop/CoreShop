...
export class DynamicTypeFieldDefinitionCoreShopProductQuantityPriceRules extends DynamicTypeFieldDefinitionCoreShopAbstract {
  id: string = 'coreShopProductQuantityPriceRules'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_product_quantity_price_rules' }
  }
