...
namespace CoreShop\Bundle\IndexBundle\Worker\ElasticsearchWorker\Listing;
...
class Dao
{
    ...
    public function __construct(private \CoreShop\Bundle\IndexBundle\Worker\ElasticsearchWorker\Listing $model)
    {
    }
