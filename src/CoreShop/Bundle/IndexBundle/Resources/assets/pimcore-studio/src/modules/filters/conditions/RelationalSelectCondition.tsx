/**
 * CoreShop IndexBundle Relational Select Filter Condition
 *
...
/**
 * Relational Select Condition - Single-select dropdown for relational data
 *
 * Similar to SelectCondition but optimized for relational fields
 *
 * Form fields:
 * - field: Index field to filter
 * - preSelect: Default selected value
 */
export const RelationalSelectCondition: React.FC<ConditionProps> = ({
  data,
  onChange,
  indexId
}) => {
  ...
  return (
    <Form layout="vertical">
      ...
      <Form.Item label={t('coreshop_filters_preselect', { defaultValue: 'Pre-Select' })}>
        <Select
