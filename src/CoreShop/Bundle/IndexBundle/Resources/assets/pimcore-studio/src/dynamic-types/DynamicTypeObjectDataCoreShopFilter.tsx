...
export const loadFilters = async (): Promise<Option[]> => {
  if (cachedOptions) return cachedOptions
  if (loadPromise) return loadPromise

  loadPromise = (async () => {
    try {
      const rows = await filterApi.list()
...
const FilterSelectInner: React.FC<{
  value?: number
...
export class DynamicTypeObjectDataCoreShopFilter extends DynamicTypeObjectDataAbstractSelect {
  readonly id = 'coreShopFilter'
