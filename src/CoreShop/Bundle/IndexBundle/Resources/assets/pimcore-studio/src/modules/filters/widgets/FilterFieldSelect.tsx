/**
 * CoreShop IndexBundle - Filter Field Select Widget
 *
 * Schema widget for selecting a single index field.
...
export const FilterFieldSelect: React.FC<FilterFieldSelectProps> = ({ value, onChange }) => {
