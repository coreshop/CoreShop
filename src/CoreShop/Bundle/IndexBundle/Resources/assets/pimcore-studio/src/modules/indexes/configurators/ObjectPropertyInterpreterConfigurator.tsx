/**
 * CoreShop IndexBundle Object Property Interpreter Configurator
 *
...
export const ObjectPropertyInterpreterConfigurator: React.FC<ConfigComponentProps> = ({ value, onChange }) => {
