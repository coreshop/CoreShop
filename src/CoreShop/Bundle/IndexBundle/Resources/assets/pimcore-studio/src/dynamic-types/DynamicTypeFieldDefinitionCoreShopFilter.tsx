...
export class DynamicTypeFieldDefinitionCoreShopFilter extends DynamicTypeFieldDefinitionCoreShopSelect {
  id: string = 'coreShopFilter'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_filter' }
  }
}
