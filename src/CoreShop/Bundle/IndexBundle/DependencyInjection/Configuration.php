            ...
            ->arrayNode('pimcore_admin')
                ...
                ->children()
                    ...
                    ->arrayNode('editmode_js')
                        ...
                        ->ignoreExtraKeys(false)
                        ->children()
                            ->scalarNode('core_extension_document_tag_filter')->defaultValue('/bundles/coreshopindex/pimcore/js/coreExtension/document/coreShopFilter.js')->end()
                            ->scalarNode('core_extension_document_tag_index')->defaultValue('/bundles/coreshopindex/pimcore/js/coreExtension/document/coreShopIndex.js')->end()
                        ->end()
                    ->end()
