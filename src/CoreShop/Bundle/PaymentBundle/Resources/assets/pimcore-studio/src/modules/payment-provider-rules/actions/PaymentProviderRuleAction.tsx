...
interface PaymentProviderRuleActionConfig {
  paymentProviderRule?: number
}

export const PaymentProviderRuleAction: React.FC<ActionComponentProps> = ({
  data,
  onChange
}) => {
  ...
  return (
    <Form.Item
      label={t('coreshop_action_paymentProviderRule', { defaultValue: 'Payment Provider Rule' })}
    >
