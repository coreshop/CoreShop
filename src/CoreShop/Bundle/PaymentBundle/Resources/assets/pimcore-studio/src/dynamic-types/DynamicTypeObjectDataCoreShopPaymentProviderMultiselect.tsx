...
import { loadPaymentProviders } from './DynamicTypeObjectDataCoreShopPaymentProvider'

const PaymentProviderMultiSelectInner: React.FC<{
  value?: number[]
...
export class DynamicTypeObjectDataCoreShopPaymentProviderMultiselect extends DynamicTypeObjectDataAbstractMultiSelect {
  ...
  getObjectDataComponent(props: any): React.ReactElement {
    ...
    return (
      <PaymentProviderMultiSelectInner
        value={rest.value}
