...
namespace CoreShop\Bundle\TelemetryBundle;

use Composer\InstalledVersions;
use Pimcore\Extension\Bundle\AbstractPimcoreBundle;

final class CoreShopTelemetryBundle extends AbstractPimcoreBundle
{
    public function getNiceName(): string
    {
        return 'CoreShop - Telemetry';
    }

    public function getDescription(): string
    {
        return 'CoreShop - Telemetry Bundle';
    }
    ...
    {
        $bundleName = 'coreshop/telemetry-bundle';
