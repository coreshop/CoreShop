...
class QuoteNumberGenerator extends SequenceNumberGenerator
{
    /**
    ...
    public function generate(ResourceInterface $model)
    {
        ...
        return sprintf('%s%s%s', $this->configurationService->getForStore('system.quote.prefix'), $number, $this->configurationService->getForStore('system.quote.suffix'));
    }
}
