...
export const InvoiceTransitionCondition: React.FC<ConditionComponentProps> = (props) => {
  const { t } = useTranslation()

  return (
    <TransitionConditionBase
      {...props}
      workflowName={WorkflowNames.INVOICE}
      label={t('coreshop_invoice_transition', { defaultValue: 'Invoice Transition' })}
    />
  )
}
