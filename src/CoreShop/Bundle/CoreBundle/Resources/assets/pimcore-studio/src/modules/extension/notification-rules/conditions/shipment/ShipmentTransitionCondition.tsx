...
export const ShipmentTransitionCondition: React.FC<ConditionComponentProps> = (props) => {
  const { t } = useTranslation()

  return (
    <TransitionConditionBase
      {...props}
      workflowName={WorkflowNames.SHIPMENT}
      label={t('coreshop_shipment_transition', { defaultValue: 'Shipment Transition' })}
    />
  )
}
