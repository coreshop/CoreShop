...
export const OrderTransitionCondition: React.FC<ConditionComponentProps> = (props) => {
  const { t } = useTranslation()

  return (
    <TransitionConditionBase
      {...props}
      workflowName={WorkflowNames.ORDER}
      label={t('coreshop_order_transition', { defaultValue: 'Order Transition' })}
    />
  )
}
