...
pimcore.registerNS('coreshop.paymentproviderrule.conditions.stores');
coreshop.paymentproviderrule.conditions.stores = Class.create(coreshop.rules.conditions.abstract, {
    type: 'stores',
