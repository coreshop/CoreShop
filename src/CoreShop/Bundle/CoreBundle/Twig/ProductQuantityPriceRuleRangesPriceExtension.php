...
final class ProductQuantityPriceRuleRangesPriceExtension extends \Twig_Extension
{
    /**
    ...
    {
        return [
            new \Twig_SimpleFunction('coreshop_quantity_price_rule_range_price', [$this->helper, 'getQuantityPriceRuleRangePrice']),
        ];
    }
}
