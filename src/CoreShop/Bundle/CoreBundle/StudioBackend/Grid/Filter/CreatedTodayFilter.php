...
/**
 * Studio v2 grid filter that shows only items created today.
 */
final class CreatedTodayFilter implements StudioGridFilterInterface
{
    public const COLUMN_TYPE = 'coreshop_created_today';
    ...
    {
        return 'coreshop_grid_filter_created_today';
    }
