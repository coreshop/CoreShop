...
/**
 * Studio v2 grid filter that shows only items created this month.
 */
final class CreatedThisMonthFilter implements StudioGridFilterInterface
{
    public const COLUMN_TYPE = 'coreshop_created_this_month';
    ...
    {
        return 'coreshop_grid_filter_created_this_month';
    }
