...
/**
 * Studio v2 grid filter that shows only items created last year.
 */
final class CreatedLastYearFilter implements StudioGridFilterInterface
{
    public const COLUMN_TYPE = 'coreshop_created_last_year';
    ...
    {
        return 'coreshop_grid_filter_created_last_year';
    }
    ...
    public function apply(mixed $parameters, QueryInterface $query): QueryInterface
    {
        ...
        $endOfLastYear = Carbon::now()->subYear()->endOfYear()->addDay();
