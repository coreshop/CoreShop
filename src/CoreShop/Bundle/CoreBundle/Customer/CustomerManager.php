...
class CustomerManager implements CustomerManagerInterface
{
    ...
    public function persistCustomer(CustomerInterface $customer)
    {
        ...
        $customer->setParent($this->objectService->createFolderByPath(sprintf('/%s/%s', ($userBackup ? $this->guestFolder : $this->customerFolder), mb_strtoupper(mb_substr($customer->getLastname(), 0, 1)))));
