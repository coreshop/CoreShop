...
class Version20190226122625 extends AbstractPimcoreMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        if (!$schema->hasTable('coreshop_product_unit')) {
            ...
            $this->addSql('CREATE TABLE coreshop_product_unit (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_803A19D05E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8MB4 COLLATE utf8mb4_general_ci ENGINE = InnoDB;');
            ...
            $this->addSql('CREATE TABLE coreshop_product_unit_definition_price (id INT AUTO_INCREMENT NOT NULL, unit_definition INT NOT NULL, product_store_values INT DEFAULT NULL, price INT NOT NULL, INDEX IDX_13ECB5B6B98B918 (unit_definition), INDEX IDX_13ECB5BD314F81B (product_store_values), UNIQUE INDEX store_values_unit_definition (product_store_values, unit_definition), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8MB4 COLLATE utf8mb4_general_ci ENGINE = InnoDB;');
            ...
            // upgrade quantity price range: add unit definition row
            $this->addSql('CREATE UNIQUE INDEX UNIQ_C6BA05DA6B98B918 ON coreshop_product_quantity_price_rule_range (unit_definition);');
        }
