    ...
    public function up(Schema $schema)
    {
        ...
        if (!$schema->hasTable('coreshop_product_unit')) {
            $this->addSql('
                ...
                CREATE TABLE coreshop_product_unit_definition_price (id INT AUTO_INCREMENT NOT NULL, unit_definition INT NOT NULL, product_store_values INT DEFAULT NULL, price INT NOT NULL, INDEX IDX_13ECB5B6B98B918 (unit_definition), INDEX IDX_13ECB5BD314F81B (product_store_values), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8MB4 COLLATE utf8mb4_general_ci ENGINE = InnoDB;
