...
class Version20200415152858 extends AbstractPimcoreMigration implements ContainerAwareInterface
{
    ...
    {
        $this->writeMessage('Start migration for Order Shipment Item Class Fields');
