...
class Version20200415154821 extends AbstractPimcoreMigration implements ContainerAwareInterface
{
    ...
    {
        $this->writeMessage('Start migration for Order Item Objects');
