...
class Version20190114155520 extends AbstractPimcoreMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        if (!$schema->hasTable('coreshop_product_tier_price')) {
            $this->addSql('CREATE TABLE coreshop_product_tier_price_range (id INT AUTO_INCREMENT NOT NULL, range_from INT NOT NULL, range_to INT NOT NULL, pricing_behaviour VARCHAR(255) NOT NULL, amount INT NOT NULL, percentage DOUBLE PRECISION NOT NULL, pseudo_price INT NOT NULL, highlighted TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8MB4 COLLATE utf8mb4_general_ci ENGINE = InnoDB;');
