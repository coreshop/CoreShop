...
class Version20190114155520 extends AbstractPimcoreMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        if (!$schema->hasTable('coreshop_product_tier_price')) {
            $this->addSql('CREATE TABLE coreshop_product_tier_price_range (id INT AUTO_INCREMENT NOT NULL, range_from INT NOT NULL, range_to INT NOT NULL, price INT NOT NULL, percentage_discount DOUBLE PRECISION NOT NULL, highlighted TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8MB4 COLLATE utf8mb4_general_ci ENGINE = InnoDB;');
            $this->addSql('CREATE TABLE coreshop_product_specific_tier_price_rule (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, inherit TINYINT(1) NOT NULL, priority INT NOT NULL, product INT NOT NULL, creationDate DATETIME NOT NULL, modificationDate DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8MB4 COLLATE utf8mb4_general_ci ENGINE = InnoDB;');
