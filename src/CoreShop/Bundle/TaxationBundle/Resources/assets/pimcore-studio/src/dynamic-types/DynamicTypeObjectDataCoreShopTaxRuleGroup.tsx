...
export const loadTaxRuleGroups = async (): Promise<Option[]> => {
...
const TaxRuleGroupSelectInner: React.FC<{
  value?: number
...
export class DynamicTypeObjectDataCoreShopTaxRuleGroup extends DynamicTypeObjectDataAbstractSelect {
