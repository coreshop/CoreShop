...
export class DynamicTypeFieldDefinitionCoreShopTaxRate extends DynamicTypeFieldDefinitionCoreShopSelect {
  id: string = 'coreShopTaxRate'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_tax' }
  }
}
