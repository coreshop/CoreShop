...
export class DynamicTypeFieldDefinitionCoreShopTaxRuleGroup extends DynamicTypeFieldDefinitionCoreShopSelect {
  id: string = 'coreShopTaxRuleGroup'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_taxation' }
  }
}
