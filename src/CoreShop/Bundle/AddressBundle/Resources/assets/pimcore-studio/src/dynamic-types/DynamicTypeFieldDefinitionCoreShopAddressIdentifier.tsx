...
export class DynamicTypeFieldDefinitionCoreShopAddressIdentifier extends DynamicTypeFieldDefinitionCoreShopSelect {
  id: string = 'coreShopAddressIdentifier'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_address_identifier' }
  }
}
