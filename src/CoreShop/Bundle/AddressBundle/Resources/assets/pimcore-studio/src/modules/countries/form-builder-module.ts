/**
 * CoreShop AddressBundle - Country Form Builder Module
 *
 * Registers the Country form builder in the container.
 *
...
export const CountryFormBuilderModule: AbstractModule = {
  onInit(): void {
    ...
    container.bind('CoreShop/Address/Country/FormBuilder')
