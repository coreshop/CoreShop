...
import { loadCountries } from '../components/CountrySelect'

const CountryMultiSelectInner: React.FC<{
  value?: number[]
...
export class DynamicTypeObjectDataCoreShopCountryMultiselect extends DynamicTypeObjectDataAbstractMultiSelect {
