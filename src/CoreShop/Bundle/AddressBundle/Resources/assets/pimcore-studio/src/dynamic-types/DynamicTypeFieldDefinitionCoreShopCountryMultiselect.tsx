...
export class DynamicTypeFieldDefinitionCoreShopCountryMultiselect extends DynamicTypeFieldDefinitionCoreShopMultiselect {
  id: string = 'coreShopCountryMultiselect'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_country' }
  }
}
