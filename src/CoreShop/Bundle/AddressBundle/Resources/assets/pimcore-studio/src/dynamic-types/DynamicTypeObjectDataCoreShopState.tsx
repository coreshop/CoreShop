...
export const loadStates = async (): Promise<Option[]> => {
...
const StateSelectInner: React.FC<{
  value?: number
...
export class DynamicTypeObjectDataCoreShopState extends DynamicTypeObjectDataAbstractSelect {
