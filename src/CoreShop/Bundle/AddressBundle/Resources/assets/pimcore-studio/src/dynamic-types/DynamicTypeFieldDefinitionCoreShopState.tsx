...
export class DynamicTypeFieldDefinitionCoreShopState extends DynamicTypeFieldDefinitionCoreShopSelect {
  id: string = 'coreShopState'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_state' }
  }
}
