...
class IndexController extends ResourceController
{
    ...
    public function getConfigAction(): Response
    {
        ...
        foreach ($interpreters as $interpreter) {
            $class = $this->get('coreshop.registry.elasticsearch.interpreter')->get($interpreter);
         ...
         */
        $fieldTypes = $this->container->getParameter('coreshop.elasticsearch.mapping_types');
        $fieldTypesResult = [];
    ...
    {
        return $this->container->getParameter('coreshop.elasticsearch.interpreters');
    }
    ...
    {
        return $this->container->getParameter('coreshop.elasticsearch.getters');
    }
    ...
    {
        return $this->container->getParameter('coreshop.elasticsearch.workers');
    }
}
