...
export class DynamicTypeFieldDefinitionCoreShopCurrencyMultiselect extends DynamicTypeFieldDefinitionCoreShopMultiselect {
  id: string = 'coreShopCurrencyMultiselect'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_icon_currency' }
  }
}
