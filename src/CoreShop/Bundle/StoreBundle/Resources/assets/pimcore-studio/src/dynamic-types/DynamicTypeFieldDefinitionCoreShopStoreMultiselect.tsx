...
export class DynamicTypeFieldDefinitionCoreShopStoreMultiselect extends DynamicTypeFieldDefinitionCoreShopMultiselect {
  id: string = 'coreShopStoreMultiselect'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_stores' }
  }
}
