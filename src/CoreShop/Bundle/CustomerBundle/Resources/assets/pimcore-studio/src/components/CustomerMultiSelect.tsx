...
export const CustomerMultiSelect: React.FC<CustomerMultiSelectProps> = ({
    ...
    const [relationValue, handleRelationChange, loading] = useRelationIds(value, 'Customer')
    ...
    const computedLabel = label ?? (labelKey ? t(labelKey) : t('coreshop_customers', { defaultValue: 'Customers' }))
