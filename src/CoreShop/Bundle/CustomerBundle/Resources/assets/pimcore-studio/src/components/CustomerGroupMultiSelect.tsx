...
export interface CustomerGroupMultiSelectProps {
    name?: string
    label?: string
    labelKey?: string
...
export const CustomerGroupMultiSelect: React.FC<CustomerGroupMultiSelectProps> = ({
    name = 'customerGroups',
    label,
    labelKey,
    value,
    ...
    const [relationValue, handleRelationChange, loading] = useRelationIds(value, 'CustomerGroup')
    ...
    const computedLabel = label ?? (labelKey ? t(labelKey) : t('coreshop_customer_groups', { defaultValue: 'Customer Groups' }))
