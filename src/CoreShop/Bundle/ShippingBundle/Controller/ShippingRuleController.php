...
class ShippingRuleController extends ResourceController
{
    public function getConfigAction(Request $request, RuleFormSchemaCollector $schemaCollector): Response
    {
        ...
        $conditionFormTypes = $this->getParameter('coreshop.shipping_rule.conditions.form_types');
        $actionFormTypes = $this->getParameter('coreshop.shipping_rule.actions.form_types');
