...
export class DynamicTypeFieldDefinitionCoreShopCarrierMultiselect extends DynamicTypeFieldDefinitionCoreShopMultiselect {
  id: string = 'coreShopCarrierMultiselect'

  getIcon(): ElementIcon {
    return { type: 'name', value: 'coreshop_carriers' }
  }
}
