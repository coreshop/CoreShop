...
{
    public function __construct(private ProductPriceRuleRepositoryInterface $productPriceRuleRepository, private RuleValidationProcessorInterface $ruleValidationProcessor)
    {
    }
