...
{
    public function __construct(private PurchasableWholesalePriceCalculatorInterface $wholesalePriceCalculator, private CartContextResolverInterface $cartContextResolver)
    {
    }
