...
namespace CoreShop\Component\Elasticsearch\Extension;

use CoreShop\Component\Index\Extension\IndexColumnTypeConfigExtension;
use CoreShop\Component\Index\Model\IndexColumnInterface;
use CoreShop\Component\Index\Model\IndexInterface;

class DecimalElasticsearchColumnTypeConfigExtension implements IndexColumnTypeConfigExtension
{
    ...
    {
        return $index->getWorker() === 'elasticsearch';
    }
}
